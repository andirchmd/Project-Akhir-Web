<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = mysqli_query($db,"INSERT INTO pembelian (nama_produk,total_bayar,nama_lengkap,email_pembeli,alamat_pembeli,nomor_cc,tanggal_transaksi)  VALUES('$nama', '$harga','$namalengkap','$email','$alamat','$cc','$tanggal')");
        if($query){
        echo "<script>
